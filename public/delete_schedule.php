...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['schedule_id'])) {
    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            $error = "Error: Could not delete the schedule.";
        }
...
try {
    ...
    if (isset($_GET['section_id'])) {
        ...
        // Fetch schedules for the selected section added by the instructor
        $stmt = $conn->prepare("SELECT schedules.schedule_id, sections.section_name, schedules.day, schedules.period, schedules.subject, rooms.room_no
                                ...
                                WHERE schedules.section_id = :section_id AND schedules.user_id = :user_id
                                ORDER BY FIELD(schedules.day, 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'), schedules.period");        $stmt->bindParam(':section_id', $section_id);
        $stmt->bindParam(':user_id', $user_id);
        $stmt->execute();
...
<title>ScheduleHub - Delete Schedule</title>
    ...
    <div class="container position-relative">
        ...
        <section id="events" class="events section" style="background-color:rgba(14, 23, 33, 0.04);">
            <div class="form-container">
                ...
                <?php endif; ?>
                <form method="GET" action="delete_schedule.php">
                    <div class="mb-3">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form method="POST" action="delete_schedule.php" style="display:inline;">
                                                ...
                                                <button type="submit" class="cta-btn btn-danger btn-sm">Delete</button>
                                            </form>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
